...
export default function WordToWordTranslationChapter47() {
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 47. Noble Character And Habits Of Sayyidina Rasoolullah</h2><br /></center>
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter47' +'/#Hadith'+(loop1+1)} style={{ color:"black"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter47' +'/#Hadith'+(loop1+1)} style={{ color:"black"}}>View English Translation </HashLink></h6>
      </div>
  ...
  <br />
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="PreviousButton" type="button" onClick = {WordToWordTranslationChapter46} >View Previous Chapter</button>
           <div style={{ marginLeft: '700px' }}></div> {/* Add margin between buttons */}
        <button className="NextButton" type="button" onClick={WordToWordTranslationChapter48}>
          View Next Chapter
        </button>
      </div>
  </>

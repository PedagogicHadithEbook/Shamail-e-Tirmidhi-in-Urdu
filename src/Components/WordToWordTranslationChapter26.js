...
export default function WordToWordTranslationChapter26() {
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 26. Description Of The Curry Of Rasoolullah</h2><br /></center>
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter26' +'/#Hadith'+(loop1+1)} style={{ color:"black"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter26' +'/#Hadith'+(loop1+1)} style={{ color:"black"}}>View English Translation </HashLink></h6>
      </div>
  ...
  <br />
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="PreviousButton" type="button" onClick = {WordToWordTranslationChapter25} >View Previous Chapter</button>
           <div style={{ marginLeft: '700px' }}></div> {/* Add margin between buttons */}
        <button className="NextButton" type="button" onClick={WordToWordTranslationChapter27}>
          View Next Chapter
        </button>
      </div>
  </>

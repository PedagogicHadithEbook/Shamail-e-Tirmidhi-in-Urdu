...
export default function EnglishTranslationChapter54() {
 ...
 const loop2=[374,375,376,377,378,379,380,381,382]
...
const handleShareClick = (loop) => {
  ...
  return (
    ...
    {/* eslint-disable-next-line */}
      <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter54' +'/#Hadith'+(loop+1)} style={{ color:"black"}}>View Urdu Translation</HashLink></h6>
      {/* eslint-disable-next-line */}
      <h6><HashLink to={'/WordToWordTranslationChapters/WordToWordTranslationChapter54' +'/#Hadith'+(loop+1)} style={{ color:"black"}}>View Word-By-Word Grammar</HashLink></h6>
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="PreviousButton" type="button" onClick = {EnglishTranslationChapter53} >View Previous Chapter</button>
           <div style={{ marginLeft: '700px' }}></div> {/* Add margin between buttons */}
        <button className="NextButton" type="button" onClick={EnglishTranslationChapter55}>
          View Next Chapter
        </button>
      </div>

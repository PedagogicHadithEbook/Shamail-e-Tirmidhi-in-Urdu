    ...
    {/* hadith container */}
     {
      ...
      {/* eslint-disable-next-line */}
      <h6><HashLink to={"/EnglishTranslationChapters/EnglishTranslationChapter55"+"/#Hadith"+(loop+1)} style={{ color:"black"}}>View English Translation</HashLink></h6>
      {/* eslint-disable-next-line */}
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="PreviousButton" type="button" onClick = {UrduTranslationChapter54} >View Previous Chapter</button>

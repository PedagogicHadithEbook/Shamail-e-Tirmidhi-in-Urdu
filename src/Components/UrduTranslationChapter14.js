    ...
    {/* hadith container */}
     {
      ...
      {/* eslint-disable-next-line */}
      <h6><HashLink to={"/EnglishTranslationChapters/EnglishTranslationChapter14"+"/#Hadith"+(loop+1)} style={{ color:"black"}}>View English Translation</HashLink></h6>
      {/* eslint-disable-next-line */}
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="PreviousButton" type="button" onClick = {UrduTranslationChapter13} >View Previous Chapter</button>
           <div style={{ marginLeft: '700px' }}></div> {/* Add margin between buttons */}
        <button className="NextButton" type="button" onClick={UrduTranslationChapter15}>
          View Next Chapter
        </button>
      </div>
   </>
